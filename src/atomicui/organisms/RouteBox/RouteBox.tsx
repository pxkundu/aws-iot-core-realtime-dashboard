...
const RouteBox: FC<RouteBoxProps> = ({
  ...
  const getDuration = useCallback(
    (mode: TravelMode) => {
      const route = routeDataForMobile?.find(r => Object.prototype.hasOwnProperty.call(r, mode));
        ...
        {iconsByTravelMode.map(({ mode, IconComponent }) => {
          ...
          return (
            <Flex
              ...
              onClick={() => {
                if (duration) {
                  const rd = routeDataForMobile?.find(r => Object.prototype.hasOwnProperty.call(r, mode))![mode];
                  setTravelMode(mode);
